...
if __name__ == "__main__":
    ...
    #funcs = json.load(open(r"E:\LLM\parameters.json", 'r'))
    funcs = json.load(open(r"D:\all_ida_json\gcc-4.1.2-O0-mips.json", 'r'))

    memcpy=['alps_lib_toupper', 'blt_str_utf8_cpy', 'sstrncpy', 'strlcpy', '__cpy', 'strcat', 'strcpy', 'strncat', 'strncpy', 'memmove', 'mempcpy', 'stpcpy', 'memccpy', 'memcpy', 'wcscat', 'wcscpy', 'wcsncat', 'wcsncpy', 'wmemcpy', 'wmemmove', 'wmempcpy', 'wcsxfrm', 'wcpncpy']
